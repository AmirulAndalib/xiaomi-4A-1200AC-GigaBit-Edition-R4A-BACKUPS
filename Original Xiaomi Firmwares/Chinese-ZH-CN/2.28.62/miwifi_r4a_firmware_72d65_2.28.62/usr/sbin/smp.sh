...
if [ $OPTIMIZED_FOR == "wifi" ]; then
    ...
    if [ $NUM_OF_CPU == "4" ]; then
        ...
        if [ "$CONFIG_RALINK_MT7621" = "y" ]; then
            ...
            echo f > /sys/class/net/wl1/queues/rx-0/rps_cpus # WiFi 2.4G
            echo f > /sys/class/net/wl0/queues/rx-0/rps_cpus # WiFi 5G
            ...
            if [ "$wifiDomain1" == "$wifiDomain2" ]; then
                ...
                if [ "$wifiDomain1" == "5G" ]; then
                    ...
                    echo f > /sys/class/net/eth0/queues/rx-0/rps_cpus # Wired LAN
                    echo f > /sys/class/net/eth1/queues/rx-0/rps_cpus # WAN
        ...
        if [ "$CONFIG_RALINK_MT7621" = "y" ]; then
            ...
            echo 2 > /sys/class/net/wl1/queues/rx-0/rps_cpus
    ...
    if [ $NUM_OF_CPU == "4" ]; then
        ...
        echo 2 > /sys/class/net/eth1/queues/rx-0/rps_cpus
        echo 2 > /sys/class/net/wl1/queues/rx-0/rps_cpus
        echo 2 > /sys/class/net/wl0/queues/rx-0/rps_cpus
    elif [ $NUM_OF_CPU == "2" ]; then
        if [ "$CONFIG_RALINK_MT7621" = "y" ]; then
        ...
        echo 1 > /sys/class/net/wl1/queues/rx-0/rps_cpus
        echo 1 > /sys/class/net/wl0/queues/rx-0/rps_cpus
